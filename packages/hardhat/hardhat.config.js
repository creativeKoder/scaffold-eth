...
module.exports = {
  ...
  networks: {
    ...
    mainnet: {
      url: "https://mainnet.infura.io/v3/12895cbf450946249bed703bae268231", //<---- YOUR INFURA ID! (or it won't work)
      accounts: {
        mnemonic: mnemonic(),
      },
    },
    ropsten: {
      url: "https://ropsten.infura.io/v3/12895cbf450946249bed703bae268231", //<---- YOUR INFURA ID! (or it won't work)
      accounts: {
        mnemonic: mnemonic(),
      },
    },
    goerli: {
      url: "https://goerli.infura.io/v3/12895cbf450946249bed703bae268231", //<---- YOUR INFURA ID! (or it won't work)
      accounts: {
        mnemonic: mnemonic(),
      },
    },
